"""
SFT Script — Sequential: Race SFT → Religion SFT on Mistral-7B-v0.3 (LoRA)
==========================================================================
...
OUTPUT_DIR     = "checkpoints/seq_race_sft_to_religion_sft"
...
def is_religion_example(example):
    ...
    single-axis religion bias after the initial race-SFT alignment.
    """
    text = " ".join([
...
if __name__ == "__main__":
    ...
    print("Starting sequential Race-SFT → Religion-SFT training on Mistral-7B-v0.3 (LoRA, LR=5e-5)...")
    trainer.train()
