"""
DPO Script — BiasDPO GENDER-EXTENDED on Mistral-7B-v0.3 (LoRA)
==================================================================
Dataset: BiasDPO gender subset + LLM-generated gender extension
Model:   mistralai/Mistral-7B-v0.3 (base, unaligned)
LR:      5e-5

This script extends the gender-only DPO setup by combining:
...
OUTPUT_DIR     = "../checkpoints/mistral7b_biasdpo_gender_extended_dpo"
...
# Kept in sync with mistral7b_biasdpo_gender_dpo.py and the SFT equivalent.
STRONG_GENDER = [
...
def load_and_preprocess():
    ...
    gender extension, then deduplicate and split into train/validation sets.
...
if __name__ == "__main__":
    ...
    print("Starting BiasDPO GENDER-EXTENDED DPO on Mistral-7B-v0.3 (LoRA, LR=5e-5)...")
    trainer.train()
