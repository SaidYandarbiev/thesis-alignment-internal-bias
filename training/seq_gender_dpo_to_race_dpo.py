"""
DPO Script — Sequential: Gender DPO → Race DPO on Mistral-7B-v0.3 (LoRA)
===========================================================================
...
Step 3: Apply a fresh LoRA adapter and train on the race-extended dataset
...
OUTPUT_DIR     = "checkpoints/seq_gender_dpo_to_race_dpo"
...
def is_race_example(example):
    ...
    single-axis race bias after the initial gender-DPO alignment.
    """
    text = " ".join([
...
if __name__ == "__main__":
    ...
    print("Starting sequential Gender-DPO → Race-DPO training on Mistral-7B-v0.3 (LoRA, LR=5e-5)...")
    trainer.train()
