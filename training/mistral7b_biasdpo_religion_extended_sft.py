"""
SFT Script — BiasDPO RELIGION-EXTENDED on Mistral-7B-v0.3 (LoRA)
==================================================================
Dataset: BiasDPO religion subset + LLM-generated religion extension
Model:   mistralai/Mistral-7B-v0.3 (base, unaligned)
LR:      5e-5

This script extends the religion-only SFT setup by combining:
...
OUTPUT_DIR     = "../checkpoints/mistral7b_biasdpo_religion_extended_sft"
...
# Kept in sync with mistral7b_biasdpo_religion_dpo.py and the DPO equivalent.
STRONG_RELIGION = [
...
def load_and_preprocess():
    ...
    religion extension, train only on chosen (unbiased) responses, then
...
if __name__ == "__main__":
    ...
    print("Starting BiasDPO RELIGION-EXTENDED SFT on Mistral-7B-v0.3 (LoRA, LR=5e-5)...")
    trainer.train()
