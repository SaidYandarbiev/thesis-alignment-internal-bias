"""
SFT Script — BiasDPO RACE-EXTENDED on Mistral-7B-v0.3 (LoRA)
==================================================================
Dataset: BiasDPO race subset + LLM-generated race extension
Model:   mistralai/Mistral-7B-v0.3 (base, unaligned)
LR:      5e-5

This script extends the race-only SFT setup by combining:
...
OUTPUT_DIR     = "../checkpoints/mistral7b_biasdpo_race_extended_sft"
...
if __name__ == "__main__":
    ...
    print("Starting BiasDPO RACE-EXTENDED SFT on Mistral-7B-v0.3 (LoRA, LR=5e-5)...")
    trainer.train()
