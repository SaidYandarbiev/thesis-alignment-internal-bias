"""
SFT Script — Sequential: Religion SFT → Gender SFT on Mistral-7B-v0.3 (LoRA)
============================================================================
...
OUTPUT_DIR     = "checkpoints/seq_religion_sft_to_gender_sft"
...
# religion alignment is retained or disrupted during gender training.
RACE_KEYWORDS = [
...
# religion alignment axis with the current gender training data.
RELIGION_KEYWORDS = [
...
def is_gender_example(example):
    ...
    single-axis gender bias after the initial religion-SFT alignment.
    """
    text = " ".join([
...
if __name__ == "__main__":
    ...
    print("Starting sequential Religion-SFT → Gender-SFT training on Mistral-7B-v0.3 (LoRA, LR=5e-5)...")
    trainer.train()
