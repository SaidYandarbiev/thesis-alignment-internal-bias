"""
DPO Script — Sequential: Religion DPO → Gender DPO on Mistral-7B-v0.3 (LoRA)
============================================================================
...
Step 3: Apply a fresh LoRA adapter and train on the gender-extended DPO dataset.
...
OUTPUT_DIR     = "checkpoints/seq_religion_dpo_to_gender_dpo"
...
def is_gender_example(example):
    ...
    single-axis gender bias after the initial religion-DPO alignment.
    """
    text = " ".join([
...
if __name__ == "__main__":
    ...
    print("Starting sequential Religion-DPO → Gender-DPO training on Mistral-7B-v0.3 (LoRA, LR=5e-5)...")
    trainer.train()
